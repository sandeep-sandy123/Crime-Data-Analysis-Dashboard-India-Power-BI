...
This project analyzes crime data related to sexual offenses in India using Power BI.
The goal was to explore trends, identify high-incidence regions, and uncover year-over-year growth patterns through interactive dashboards.

2. 🎯 Objectives

Analyze multi-year crime data

Identify state-wise distribution patterns
